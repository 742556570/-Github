...
public class PayChannelBankCardService2 extends CrudService<ClBnkCrdDao, ClBnkCrd> {
...
//				clBnkCrdDao.updateBankIsBind(params);
	...
	public JSONObject payChannelQuery(String acName, String acNo, String bankCode, String idNo, String phoneNo,
			String channel) {
		...
		if (channel.equals("CL0001")) {
			String signNo = "";
			if(clBnkCrd != null) {
				String tmp = clBnkCrd.getBIND_CDE();
