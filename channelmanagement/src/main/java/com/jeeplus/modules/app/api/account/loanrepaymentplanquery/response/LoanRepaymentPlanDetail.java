...
public class LoanRepaymentPlanDetail extends DataEntity<LoanRepaymentPlanDetail>{
	...
	public String toString() {
		return "LoanRepaymentPlanDetail [guarantyid=" + guarantyid
				+ ", loanacno=" + loanacno + ", overflag=" + overflag
				+ ", payoffdate=" + payoffdate + ", payoffflag=" + payoffflag
				+ ", rcapi=" + rcapi + ", rcontamt=" + rcontamt + ", rfine="
				+ rfine + ", rinsuamt=" + rinsuamt + ", rinte=" + rinte
				+ ", scapi=" + scapi + ", scontamt=" + scontamt + ", sdate="
				+ sdate + ", sfine=" + sfine + ", sinsuamt=" + sinsuamt
				+ ", sinte=" + sinte + ", sterm=" + sterm + "]";
	}
