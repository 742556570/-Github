...
public class FormUploader {
	...
	private final static Logger logger = LoggerFactory.getLogger(FormUploader.class); 

    // 默认的超时时间：30秒
    private int timeout = 300 * 1000;

    //默认过期时间
    private int expiration = 180000;

    //默认域名
    private String apiDomain = PropertiesUtil.getString("apiDomain");
    // 空间名
