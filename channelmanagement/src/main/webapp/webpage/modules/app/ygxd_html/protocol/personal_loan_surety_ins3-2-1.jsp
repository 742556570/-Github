...
<body>
		...
		<div>
			<table class="table_set">
				...
				<tr class="tr_set">
					...
					<td class="td_set80">保险单承保的贷款合同中所载明的贷款人</td>
				</tr>

				<tr class="tr_set">
					<td class="td_set20">投保人与被保险人的关系</td>
				...
				<tr class="tr_set">
					<td class="td_set20">月保险费率</td>
					<td class="td_set80">以保险单约定为准</td>
				</tr>

				<tr class="tr_set">
					<td class="td_set20">免赔额（率）</td>
	...
	<footer style="width: 100%; position: fixed; bottom: 0">
		...
		<div style="width: 100%; background: #fff; padding: 1rem 10%;">
			<p style="width: 80%; margin-bottom: 1rem" class="font8"><input id="protocol_status" type="checkbox" checked="true" name="check_protocol" style="vertical-align:text-bottom; margin-bottom:1px; margin-right: 4px">我已阅读并同意<a id="3-3" class="href_style">《个人征信授权书》</a>和<a id="3-4" class="href_style">《个人信息查询使用授权书》</a><a id="5-2" class="href_style">《保险单》</a><a id="5-4" class="href_style">《保险单信息确认》</a><a id="5-3" class="href_style">《委托扣款授权书（保费）》</a></p>
